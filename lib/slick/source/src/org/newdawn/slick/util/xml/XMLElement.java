...
public class XMLElement {
	 ...
	 * @param name The name of the attribute whose value should be retrieved
	 * @return The value given for the attribute
	 * @throws org.newdawn.slick.util.xml.SlickXMLException Indicates a failure to convert the value into an integer
	 */
	 ...
	 * @param name The name of the attribute whose value should be retrieved
	 * @return The value given for the attribute
	 * @throws org.newdawn.slick.util.xml.SlickXMLException Indicates a failure to convert the value into an double
	 */
	 ...
	 * @param name The name of the attribute whose value should be retrieved
	 * @return The value given for the attribute
	 * @throws org.newdawn.slick.util.xml.SlickXMLException Indicates a failure to convert the value into an boolean
	 */

...
public class ManhattanHeuristic implements AStarHeuristic {
	...
	/**
	 * @see org.newdawn.slick.util.pathfinding.AStarHeuristic#getCost(org.newdawn.slick.util.pathfinding.TileBasedMap, org.newdawn.slick.util.pathfinding.Mover, int, int, int, int)
	 */

...
public class GlyphPage {
	 ...
	 * @throws org.newdawn.slick.SlickException if the backing texture could not be created.
	 */
	 ...
	 * @throws org.newdawn.slick.SlickException if the glyph could not be rendered.
	 */

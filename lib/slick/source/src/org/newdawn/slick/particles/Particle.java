...
public class Particle {
	...
	/** The maxLife left in the particle */
	protected float life;
	/** The original maxLife of this particle */
	...
	/**
	 * Get the original maxLife of this particle
	 * 
	 * @return The original maxLife of this particle
	 */
	...
	/**
	 * Get the maxLife remaining in the particle in milliseconds
	 * 
	 * @return The maxLife remaining in the particle
	 */
	 ...
	 * @param life
	 *            The maxLife the particle should have (in milliseconds)
	 */
	...
	/**
	 * Set the maxLife of the particle
	 * 
	 * @param life
	 *            The maxLife of the particle in milliseconds
	 */
	...
	/**
	 * Adjust the maxLife othe particle
	 * 
	 * @param delta
